...
const SEED_PROBLEMAS: Problema[] = [
  ...
  { id: 'p2', titulo: 'Iluminação pública apagada', descricao: 'Três postes apagados na Rua Central, aumentando insegurança noturna nos últimos 2 meses.', categoria: 'Iluminação', status: 'aprovado', criadoPor: 'Maria Santos', criadoEm: '2025-06-12', validado: true, bairro: 'Pilar', votos: 41, projetoId: 'pr1' },
